...
describe('SonicxWeb.transactionBuilder', function () {
    ...
    describe('#constructor()', function () {
        ...
        it('should have been set a full instance in tronWeb', function () {
            ...
            assert.instanceOf(tronWeb.transactionBuilder, SonicxWeb.TransactionBuilder);
        });
    ...
    describe('#setAccountId()', function () {
        ...
        it(`should set account id accounts[4]`, async function () {
            ...
            for (let id of ids) {
                let accountId = SonicxWeb.toHex(id);
        ...
        it('should throw invalid owner address error', async function () {
            ...
            await assertThrow(
                tronWeb.transactionBuilder.setAccountId(SonicxWeb.toHex('testtest001'), '0xzzzww'),
                'Invalid origin address provided'
            );
    ...
    describe("#createTokenExchange", async function () {
        ...
        it('should create token exchange', async function () {
            ...
            assert.equal(transaction.txID.length, 64);
            assert.equal(SonicxWeb.toUtf8(parameter.value.first_token_id), tokenNames[0]);
            assert.equal(SonicxWeb.toUtf8(parameter.value.second_token_id), tokenNames[1]);
